...
svc=ProductMatchService(scrape_service=ProductScrapeService(guard=guard))
resp=svc.match(MatchRequest(reference_url=REF, stores=['shoppingchina'], persist=False, include_review=True, max_candidates_per_store=5))
